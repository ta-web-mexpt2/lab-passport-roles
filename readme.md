...
- Remember to use routes on your client, you can reuse your last lab (auth with passport) components since it is very similar to this one.  Anyway, We already let you with a client folder all brand new, all this is up to you. 

- You don't have to create a very elaborated frontend we just want to evaluate the performance between your backend and frontend
